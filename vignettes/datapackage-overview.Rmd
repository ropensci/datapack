...
package member are prepended with the default value of "https://cn.dataone.org/cn/v2/resolve/". A different
value can be specified with the *resoveURI* argument. To specify that no value be prepended to the 
identifier URLs, specify a zero-length character:
